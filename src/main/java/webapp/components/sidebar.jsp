...
<div class="iq-sidebar sidebar-default">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-around">
        <a href="/home/index.jsp" class="header-logo">
    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="">
                    <a href="/home/index.jsp" class="svg-icon">                        
                ...
                <li class="">
                    <a href="#goods" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">                        
                ...
                <li class="">
                    <a href="/home/workplace/workplace-list.jsp" class="svg-icon">                        
